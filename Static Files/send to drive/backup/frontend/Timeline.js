...
class Timeline extends Component {
  ...
  handleAddCategory = e => {
    e.preventDefault();
    console.log("category.......", this.state.categoryAdd);
    console.log("category....IMggg...", this.state.categoryImg.length);
    ...
    if (this.state.categoryAdd === "") {
      ...
      this.setState({ categoryAddAlert: "" });
  ...
  handleSubmit = e => {
    ...
    if (this.state.description === "" || this.state.files.length < 1) {
      ...
      this.setState({ uploadedDataAlert: "" });
