...
class Reset extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      reType_password: "",
      _id: "",
      alert: "your retype password not matched",
      password_reset: "enter email to resert pass"
    };
  }
  ...
  handleOnSubmit = event => {
    ...
    if (this.state.password === this.state.reType_password) {
      ...
      fetch("http://localhost:8081/resetPass", {
        method: "post",
        headers: {
      ...
      this.setState({
        password_reset: "both password not matched!",
